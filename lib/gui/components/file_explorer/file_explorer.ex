defmodule Flamelex.GUI.Component.FileExplorer do
  ...
  def init(scene, args, opts) do
    ...
    init_graph = render(args.frame, init_nav_tree)
  ...
  def handle_info(
        {:radix_state_change, %{projects: %{open_proj: proj}}},
        %{assigns: %{state: %{open_proj: proj}}} = scene
      ) do
  ...
  def construct_tuple_tree(root_dir) when is_bitstring(root_dir) do
    ...
    # directories get put at the top
    dir_tuples ++ file_tuples
  end
