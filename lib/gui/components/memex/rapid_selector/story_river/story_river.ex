defmodule Memelex.GUI.Components.StoryRiver do
  ...
  def init(scene, args, opts) do
    ...
    state = Flamelex.Fluxus.RadixStore.fetch().apps.rapid_selector.story_river

    # IO.inspect(state)
    init_graph = render(args |> Map.merge(%{state: state}))
    ...
    init_scene =
      ...
      |> assign(render_queue: state.open_tidbits)
