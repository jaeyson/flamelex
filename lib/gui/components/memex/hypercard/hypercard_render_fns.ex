...
#     graph
#     |> Scenic.Primitives.rect({frame.size.width - 2 * @margin, @header_height}, fill: :blue)
#   end

#   def render_header_background(graph, frame, %{gui: %{mode: :normal}}) do
#     graph
#     |> Scenic.Primitives.rect({frame.size.width - 2 * @margin, @header_height}, fill: :grey)
#   end
...
#           {frame.size.width - 2 * @margin, frame.size.height - 2 * @margin - @header_height},
#           fill: :purple
#         )
#         |> ScenicWidgets.TextPad.add_to_graph(
#           %{
...
#     %{type: ["external", "textfile"], data: %{"file_path" => journal_entry_filepath}} = tidbit
...
#         |> Scenic.Components.button("Open external text-file",
#           id: {:open_external_textfile, journal_entry_filepath},
#           t: {10, 10}
#         )
#       end,
...
#       pin: {0, 0},
#       size: {
#         tidbit_frame.size.width - 2 * @margin - @toolbar_width,
#         @title_height
#       }
#     )
#   end
...
#       pin: {0, 0},
#       size:
#         {tidbit_frame.size.width - 2 * @margin,
#          tidbit_frame.size.height - 2 * @margin - @header_height}
#     )
#   end
