defmodule Flamelex.Test.Buffers.BufferTest do
  ...
  test "the basic functionality of the API", %{test_file: test_file} do
    ...
    # the Buffer.list now contains the buffer we just opened
    assert Buffer.list() == [b]
    ...
    # read it again to get the update...
    contents_after_modify = Buffer.read(b)
    ...
    # check the contents on disk have been modified
    assert File.read!(test_file) != original_file_data
